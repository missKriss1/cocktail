...
import { cocktailDetSelect } from '../../features/cocktails/cocktailsSlice.ts';
              ...
              <div className="row d-flex mt-3">
                ...
                <div className="col-lg-6 col-md-12 d-flex flex-column">
                  ...
                  <div className="mb-4">
                    ...
                    <ul>
                      {cocktail?.ingredients && cocktail.ingredients.map((ingredient, index) => (
                  ...
                  <div>
                    ...
                    <p className="text-secondary fw-semibold fs-6">{cocktail?.recipe}</p>
                  </div>
                </div>
              </div>
            </div>
